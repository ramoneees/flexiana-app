...
3. Build a Docker image: `sudo docker build -t flexiana-backend .`
4. Run your Docker image: `docker run -p 8080:8080 flexiana-backend`
...
1. `capstan rmi flexiana-backend; capstan build`
